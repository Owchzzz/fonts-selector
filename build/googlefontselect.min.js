(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["googlefontselect"] = factory();
	else
		root["googlefontselect"] = factory();
...
var FontSelectorContainer = __webpack_require__(10);

exports.default = function (config) {
    var container = FontSelectorContainer;
    return {
        init: function init(c) {
            console.log(_config.fonts);
            var $el = $(c.container);
            $el.append(container.render());
        }
    };
};
...
var SelectorContainerView = __webpack_require__(11);
var SelectorContainer = __webpack_require__(13);
module.exports = function () {
    var scv = void 0,
        sc = void 0;
    sc = new SelectorContainer();
    scv = new SelectorContainerView(sc);
...
module.exports = Backbone.View.extend({
    ...
    initialize: function initialize(o) {
        ...
        this.selectors = [];
        this.$selectors = $el.find('.selectors');
        _.each(o.selectors, function (selector) {
            _this.$selectors.append(selector);
        });
    }
});
