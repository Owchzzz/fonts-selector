(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["bzfontselector"] = factory();
	else
		root["bzfontselector"] = factory();
...
var FontSelectorContainer = __webpack_require__(11);

module.exports = function (o) {
    var fcontainer = void 0;
    var fonts = void 0;
    var $el = void 0;
    return {
        value: false,
        ...
        init: function init(c) {
            ...
            _config.opts.parent = this;

            //Initialize the container
            fcontainer.initialize(fonts, _config.opts);
...
// module
exports.push([module.i, "/**\r\nStyle imports\r\n**/\n/** Plugin Settings **/\n.bfxselect {\n  display: block;\n  background-color: #fafafa;\n  width: 100%;\n  font-family: Century Gothic;\n  position: relative;\n  -webkit-font-smoothing: antialiased; }\n  .bfxselect .selector-btn {\n    position: relative;\n    display: block;\n    width: 100%;\n    text-align: center;\n    cursor: pointer;\n    height: 45px;\n    font-size: 12px;\n    background-color: none;\n    overflow: hidden;\n    border-radius: 8px;\n    border: 1px solid #d3d3d3; }\n    .bfxselect .selector-btn input {\n      padding: 3px 6px;\n      position: absolute;\n      left: 0;\n      width: 100%;\n      height: 100%;\n      border: 0px; }\n    .bfxselect .selector-btn i {\n      font-size: 18px;\n      line-height: 2.3;\n      position: absolute;\n      right: 0;\n      width: 50px;\n      height: 100%;\n      display: block;\n      background: linear-gradient(#e0e1e5, #f1f2f4);\n      border: 0; }\n  .bfxselect .selectors {\n    position: relative;\n    width: 100%;\n    top: 2px;\n    left: 0;\n    display: none; }\n    .bfxselect .selectors .header {\n      background-color: #0074c7;\n      padding: 10px; }\n      .bfxselect .selectors .header h1 {\n        float: left;\n        display: block;\n        color: white;\n        font-size: 18px; }\n      .bfxselect .selectors .header b {\n        float: right;\n        display: block;\n        padding: 5px 12px;\n        background-color: #005d9f;\n        color: white;\n        cursor: pointer;\n        margin-top: 7px;\n        border-radius: 2px;\n        -webkit-border-radius: 2px;\n        -moz-border-radius: 2px; }\n    .bfxselect .selectors .contents {\n      position: relative;\n      max-height: 300px;\n      overflow-y: scroll; }\n      .bfxselect .selectors .contents .bfxselect-selectable {\n        width: 8.33333%;\n        vertical-align: center;\n        float: left;\n        text-align: center;\n        background-color: white;\n        cursor: pointer;\n        display: block; }\n        .bfxselect .selectors .contents .bfxselect-selectable .selectable-content {\n          border: 1px solid #fafafa; }\n          .bfxselect .selectors .contents .bfxselect-selectable .selectable-content:hover {\n            background-color: #fafafa; }\n          .bfxselect .selectors .contents .bfxselect-selectable .selectable-content i {\n            font-size: 18px;\n            display: block;\n            margin: 10px auto;\n            color: #464646; }\n", ""]);
...
var SelectorContainerView = __webpack_require__(12);
var SelectorContainer = __webpack_require__(16);
...
module.exports = function () {
    ...
    return {
        ...
        initialize: function initialize(o, opts) {
            var fonts = o;
 ...
 */
var Backbone = __webpack_require__(0);
var SelectorView = __webpack_require__(15);
...
module.exports = Backbone.View.extend({
    ...
    initialize: function initialize(o) {
        ...
        this.fonts.each(function (font) {
            ...
            $(_this.selectors).find('.contents').append(selector.render().$el);
            _this.listenTo(selector, 'onChange', _this.changed);
        });
    },
    ...
    toggleSelectors: function toggleSelectors(e) {

        if (!this.toggled) $(this.selectors).show();else $(this.selectors).hide();
